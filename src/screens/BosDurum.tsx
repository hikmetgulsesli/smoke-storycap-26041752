...
export function BosDurum(props: BosDurumProps) {
  return (
    <>
      ...
      <div className="flex items-center gap-4">
      <button className="p-2 text-[#5A6C80] hover:bg-[#EFF4FF] dark:hover:bg-[#1A2B40] transition-colors rounded-full scale-95 active:scale-90 transition-transform flex items-center justify-center">
      ...
      <span className="font-display font-[800] text-[5rem] leading-none text-on-surface tracking-tighter opacity-40">0</span>
      </div>
      </div>
      {/*  Controls  */}
      <div className="w-full flex gap-4 justify-center items-center">
      <button className="bg-secondary-container text-on-secondary-container w-[72px] h-[72px] rounded-[1rem] flex items-center justify-center hover:bg-surface-variant transition-colors group">
      ...
      <button className="bg-gradient-to-br from-primary to-primary-container text-on-primary w-[96px] h-[96px] rounded-[1rem] flex items-center justify-center shadow-[0_8px_32px_-12px_rgba(0,74,198,0.4)] hover:opacity-90 transition-opacity group">
      ...
      <button className="bg-tertiary text-on-tertiary w-[72px] h-[72px] rounded-[1rem] flex items-center justify-center hover:opacity-90 transition-opacity group">
      ...
      <a className="flex flex-col items-center justify-center bg-[#EFF4FF] dark:bg-[#2563EB]/20 text-[#004AC6] dark:text-[#2563EB] rounded-2xl px-5 py-2 hover:opacity-80 transition-opacity scale-98 active:scale-95 transition-all w-1/3" href="#">
      ...
      <a className="flex flex-col items-center justify-center text-[#5A6C80] dark:text-[#C3C6D7] px-5 py-2 hover:opacity-80 transition-opacity scale-98 active:scale-95 transition-all w-1/3" href="#">
